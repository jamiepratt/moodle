 ...
 *
 */
function quiz_attempt_start_new_built_on_last($quba, $attempt, $lastattempt) {
...
/**
 * The db operations related to the attempt start.
 *
 * @param question_usage_by_activity $quba
 * @param object                     $attempt
 * @return object                    attempt object with uniqueid and id set.
 */
function quiz_attempt_save_started($quba, $attempt) {
    global $DB;
 ...
 * @param quiz                       $quizobj
 */
function quiz_attempt_log_started($attempt, $course, $quizobj) {
    // Log the new attempt.
    if ($attempt->preview) {
...
function quiz_attempt_trigger_event_started($attempt, $quizobj) {
    // Trigger event.
