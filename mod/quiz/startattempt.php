...
if (!($quizobj->get_quiz()->attemptonlast && $lastattempt)) {
    $attempt = quiz_attempt_start_new($quizobj, $quba, $attempt, $attemptnumber, $timenow);
} else {
    $attempt = quiz_attempt_start_new_built_on_last($quba, $attempt, $lastattempt);
}

$transaction = $DB->start_delegated_transaction();

$attempt = quiz_attempt_save_started($quba, $attempt, $course, $quizobj);
quiz_attempt_log_started($attempt, $course, $quizobj);
quiz_attempt_trigger_event_started($attempt, $quizobj);
