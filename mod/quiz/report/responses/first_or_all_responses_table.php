...
class quiz_first_or_all_responses_table extends quiz_last_responses_table {
    ...
    protected function slot_state($attempt, $slot) {
        ...
        $submissionsteps = $qa->get_submission_step_iterator();
    ...
    public function get_no_of_tries($attempt, $slot) {
        return count($this->get_question_attempt($attempt->usageid, $slot)->get_submission_step_iterator());
    }
    ...
    protected function step_no_for_try($questionusageid, $slot, $tryno) {
        return $this->get_question_attempt($questionusageid, $slot)->get_submission_step_iterator()->step_no_for_try($tryno);
    }
