...
$string['calculatingquestionresponsestats'] = 'Calculating response stats for question ($a->slotno) $a->name';
$string['calculatingqstatsfirstiterationthroughquestions'] = 'First iteration through questions.';
$string['calculatingqstatsfirstloopthroughsteps'] = 'First loop through attempt data.';
$string['calculatingqstatsforsubquestions'] = 'Looping through any subquestions.';
$string['calculatingqstatsseconditerationthroughquestions'] = 'Second iteration through questions.';
$string['calculatingqstatsseconditerationthroughsteps'] = 'Second iteration through attempt data.';
$string['calculatingsubquestionresponsestats'] = 'Calculating response stats for subquestion ($a->slotno) $a->name';
