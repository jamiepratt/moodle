...
class all_calculated_for_qubaid_condition {
     ...
     *
     * @param $qubaids \qubaid_condition Which question usages to load stats for?
     */
     ...
     *
     * @param $qubaids \qubaid_condition Which question usages to look for stats for?
     ...
     * Save stats to db.
     *
     * @param $qubaids \qubaid_condition Which question usages are we caching the stats of?
     */
