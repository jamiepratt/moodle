...
class calculator {
     ...
     * Calculate the stats.
     *
     * @param $qubaids \qubaid_condition Which question usages to calculate the stats for?
     ...
     *
     * @param $qubaids \qubaid_condition Which question usages to get the latest steps for?
     ...
     *
     * @param $qubaids \qubaid_condition Which question usages to look for?
     ...
     *
     * @param $qubaids \qubaid_condition Which question usages to load the cached stats for?
