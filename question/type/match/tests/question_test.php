...
class qtype_match_question_test extends advanced_testcase {
    ...
    public function test_grading() {
        ...
        $correctreponse = $question->prepare_simulated_post_data(array('Mammal', 'Amphibian', 'Amphibian', 'Mammal'));
        $this->assertEquals(array(1, question_state::$gradedright), $question->grade_response($correctreponse));

        $partialresponse = $question->prepare_simulated_post_data(array('Mammal'));
        $this->assertEquals(array(0.25, question_state::$gradedpartial), $question->grade_response($partialresponse));

        $partiallycorrectresponse = $question->prepare_simulated_post_data(array('Mammal', 'Insect', 'Insect', 'Amphibian'));
        $this->assertEquals(array(0.25, question_state::$gradedpartial), $question->grade_response($partiallycorrectresponse));

        $wrongresponse = $question->prepare_simulated_post_data(array('Amphibian', 'Insect', 'Insect', 'Amphibian'));
    ...
    public function test_get_correct_response() {
        ...
        $this->assertEquals($question->prepare_simulated_post_data(array('Mammal', 'Amphibian', 'Amphibian', 'Mammal')),
    ...
    public function test_summarise_response() {
        ...
        $summary = $match->summarise_response($match->prepare_simulated_post_data(array('Amphibian', 'Mammal')));
    ...
    public function test_classify_response() {
        ...
        $response = $match->prepare_simulated_post_data(array('Amphibian', 'Insect', '', ''));
