...
function question_usage_statistics_cron() {
    ...
    $todelete = $DB->get_records_select_menu('question_usage_statistics',
    ...
    $DB->delete_records_select('question_statistics',
                               'questionusagestatsid ' . $todeletesql, $todeleteparams);

    $DB->delete_records_select('question_response_analysis',
                               'questionusagestatsid ' . $todeletesql, $todeleteparams);

    $DB->delete_records_select('question_usage_statistics',
